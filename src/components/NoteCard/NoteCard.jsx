        ...
        <div
          className={`${
            isActive
              ...
              : "card-idea w-full min-w-0 min-h-[26vh] mt-[15px] rounded-2xl shadow-lg shadow-sky-400 p-5.5 bg-sky-200 relative"
          }`}
        >
          <div
          ...
          >
            <p className={`${isActive ? "font-bold text-cyan-900" : "text-black text-sm ml-1"}`}>
              {note.category}
            </p>
          </div>
          <p
